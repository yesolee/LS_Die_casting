...
with st.container():
    ...
    col2.warning('- **분석 시작점: 2019.03.24** \n - **ActualProp: 2019.01.02.~ 2019.02.14 (시스템 도입 전)** \n - **ExpectedProp: 2019.02.15 ~ 2019.03.24 (시스템 도입 후)**')
    st.write('#### 2️⃣ 모델 생성 및 비교 (기존 모델, 신규 데이터, 기존+신규 데이터 )')
    st.image(Image.open('img/models.jpg'))
    st.write('- **분석 시작점: 2019.03.24** \n - **test: 2019.03.25 ~ 2019.03.31 (테스트 기간, 7일)** \n - **train1: 2019.01.02~ 2019.02.14 (시스템 도입 전, 모델1)** \n - **train2: 2019.02.15 ~ 2019.03.24 (시스템 도입 후, 모델2)** \n - **train3: 2019.01.02 ~ 2019.03.24 (분석 시작점까지 전체기간 , 모델3)** ')
